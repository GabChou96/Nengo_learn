...
def resize_img(img, _im_size, _im_size_new):
    ...
    img = img.resize((_im_size_new, _im_size_new), Image.Resampling.LANCZOS)
...
# Define the local path to the MNIST dataset
local_mnist_path = r"C:\Users\User\PycharmProjects\PythonProject\Nengo_learn\model\mnist.pkl.gz"
# Load the MNIST data from the local file
(x_train, y_train), (x_test, y_test) = load_mnist(local_mnist_path)
